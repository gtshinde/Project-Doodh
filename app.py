...
def view_milkman(user_id,rating):
    ...
    if (signin):
        ...
        if city is None and area is None:
            ...
            return render_template('view_modify_milkman.html',user_email=user_email,milkman_list=milkman_list,user_id=user_id,user=user, is_admin=admin)
        location_id=connection.get_location_id(city,area)
        overall_rate=''
        if rating != ' ':
        ...
        return render_template('view_modify_milkman.html',user_email=user_email,milkman_list=milkman_list,user_id=user_id,overall_rate=overall_rate,user=user, is_admin=admin)
